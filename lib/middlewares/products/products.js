...
module.exports = {
    ...
    UpdateProductSingle: (req, res) => {
        ...
        Products.updateOne({ _id: req.body._id }, {
            ...
            KeyFeatures: req.body.KeyFeatures,// == null ? req.body.KeyFeatures : req.body.KeyFeatureArr,
            PrimaryFeatures: req.body.PrimaryFeatures,// == null ? req.body.PrimaryFeatures : req.body.PrimaryFeatureArr,
